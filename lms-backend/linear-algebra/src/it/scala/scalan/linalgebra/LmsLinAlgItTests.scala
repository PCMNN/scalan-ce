...
class LmsVectorsOpsItTests extends LmsLinAlgItTests {
  ...
  test("ddvvm") {
    compareOutputWithStd(_.dd_vvm, progStagedOnly)((dv1, dv2))
  }

  test("dsvvm") {
    compareOutputWithStd(_.ds_vvm, progStagedOnly)(Pair(dv1, sv2))
  }

  test("sdvvm") {
    compareOutputWithStd(_.sd_vvm, progStagedOnly)(Pair(sv1, dv2))
  }

  test("ssvvm") {
    compareOutputWithStd(_.ss_vvm, progStagedOnly)(Pair(sv1, sv2))
  }

  test("ddvva") {
    compareOutputWithStd(_.dd_vva, progStagedOnly)(Pair(dv1, dv2))
  }

  test("dsvva") {
    compareOutputWithStd(_.ds_vva, progStagedOnly)(Pair(dv1, sv2))
  }

  test("sdvva") {
    compareOutputWithStd(_.sd_vva, progStagedOnly)(Pair(sv1, dv2))
  }

  test("ssvva") {
    compareOutputWithStd(_.ss_vva, progStagedOnly)(Pair(sv1, sv2))
  }
}
